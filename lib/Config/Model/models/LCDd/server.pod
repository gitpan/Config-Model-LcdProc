...
[default: no]I<< Optional. Type enum. choice: 'on', 'off'. upstream_default: 'on'.  >> 

=head2 Backlight

Set master backlight setting. If set to 'open' a client may control the
backlight for its own screens (only). 
[default: open]I<< Optional. Type enum. choice: 'off', 'open', 'on'. upstream_default: 'open'.  >> 
...
[default: no]I<< Optional. Type boolean. upstream_default: 'no'.  >> 
...
Sets the reporting level;  (warnings and errors only).
[default: 3]I<< Optional. Type integer. upstream_default: '2'.  >> 

=head2 ReportToSyslog

Should we report to syslog instead of stderr ? 
[default: yes]I<< Optional. Type boolean. upstream_default: 'no'.  >> 
...
is displayed. 
[default: no]I<< Optional. Type enum. choice: 'on', 'off', 'blank'. upstream_default: 'on'.  >> 

=head2 TitleSpeed

set title scrolling speed 
[default: 10]I<< Optional. Type integer. upstream_default: '10'.  >> 
