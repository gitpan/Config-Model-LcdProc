...
'haveInverter' from above). I<< Optional. Type boolean. upstream_default: 'no'.  >> 
...
three times 0xFF before a reset during initialization.I<< Optional. Type boolean. upstream_default: 'no'.  >> 
