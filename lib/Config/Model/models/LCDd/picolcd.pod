...
Link the key lights to the backlight? 
[default: off]I<< Optional. Type enum. choice: 'on', 'off'. upstream_default: 'on'.  >> 
...
[default: 0]I<< Optional. Type integer. upstream_default: '0'.  >> 
